...
相关:
- [[model-ops-no-env-vars]] — model 真相源是 `workspace_models.toml`,不走 env
- [[claude-settings-env-precedence]] — settings.local.json (Local 层) > user env
- `doc/design/09-workspace-model-registry.md` §9.5.4b 设计章节
